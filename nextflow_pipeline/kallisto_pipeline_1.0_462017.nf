...
process kallisto_mapping {
        ...
        output:
        file "kallisto" into kallisto_out_dirs
		...
		module load samtools
                ...
                kallisto quant  -i index -o kallisto  --pseudobam ${reads}|samtools view -Sb - > out.bam
...
process multiqc {
        ...
        //        file ('alignment/*') from alignment_logs.flatten().toList()
                file ('kallisto/*') from   kallisto_out_dirs.flatten().toList()
